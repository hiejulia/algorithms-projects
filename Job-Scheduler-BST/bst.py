...
class Node:
    def __init__(self, key):
        ...
        raw_sched_time = datetime.strptime(sched_time, '')
        key = raw_sched_time.time()
        end_time = (raw_sched_time )
...
class BST:
    ...
    def _insert(self, curr, key):
        ...
        elif key.data < curr.data and key.scheduled_end<=curr.left_child:
    ...
    def helper_print(self, key, succeeded):
        if succeeded:
            print()
            print()
            print()
    ...
    def __delete_val(self, curr, prev, is_left, key):
        if curr:
            if key == curr.data:
